package io.microservices.shop.oauth.service.Impl;
...
public class LoginServiceImpl implements LoginService {
    ...
    public AuthToken login(String username, String password, String clientId, String clientSecret, String grandType) {
        ...
        ServiceInstance choose = loadBalancerClient.choose("shop-oauth");
    ...
    public static void main(String[] args) {
        byte[] decode = Base64.getDecoder().decode(new String("f14029217ff5e7a50cdc7e70f686cf29").getBytes());
