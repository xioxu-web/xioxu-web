package io.microservices.shop.user.auth.controller;
...
import io.microservices.shop.jwt.common.ResponseCodeEnum;
import io.microservices.shop.jwt.common.ResponseResult;
import io.microservices.shop.jwt.config.ShopJwtProperties;
import io.microservices.shop.jwt.utils.ShopJwtTokenUtil;
import io.microservices.shop.user.auth.mapper.SysUserMapper;
...
@RestController
@RequestMapping("/auth")
public class ShopJwtAuthController {
    @Resource
    private ShopJwtProperties jwtProperties;

    @Resource
    private SysUserMapper sysUserMapper;

    @Resource
    private ShopJwtTokenUtil jwtTokenUtil;
