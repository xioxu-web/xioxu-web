...
class XxlJobHelper {
     ...
     */
    private static
    boolean logDetail(StackTraceElement callInfo, String appendLog) {
        XxlJobContext xxlJobContext = XxlJobContext.getXxlJobContext();
        if (xxlJobContext == null) {
            return false;
        }
     ...
     */
    public static
    boolean handleSuccess(String handleMsg) {
     ...
     */
    public static
    boolean handleFail(String handleMsg) {
     ...
     */
    public static
    boolean handleTimeout(String handleMsg) {
     ...
     */
    public static
    boolean handleResult(int handleCode, String handleMsg) {
        XxlJobContext xxlJobContext = XxlJobContext.getXxlJobContext();
        if (xxlJobContext == null) {
            return false;
        }
