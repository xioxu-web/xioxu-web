 ...
 */
public
class XxlJobSimpleExecutor extends XxlJobExecutor {
    ...
    public
    List<Object> getXxlJobBeanList() {
        return xxlJobBeanList;
    }

    public
    void setXxlJobBeanList(List<Object> xxlJobBeanList) {
    ...
    private
    void initJobHandlerMethodRepository(List<Object> xxlJobBeanList) {
