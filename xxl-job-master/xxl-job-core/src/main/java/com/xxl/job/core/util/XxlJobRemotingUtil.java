...
class XxlJobRemotingUtil {
    ...
    // trust-https start
    private static
    void trustAllHosts(HttpsURLConnection connection) {
        try {
     ...
     */
    public static
    ReturnT postBody(String url, String accessToken, int timeout, Object requestObj, Class returnTargClassOfT) {
