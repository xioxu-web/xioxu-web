...
class TriggerCallbackThread {
    ...
    public static
    void pushCallBack(HandleCallbackParam callback) {
     ...
     */
    private
    void callbackLog(List<HandleCallbackParam> callbackParamList, String logContent) {
    ...
    private
    void appendFailCallbackFile(List<HandleCallbackParam> callbackParamList) {
        // valid
        if (callbackParamList == null || callbackParamList.size() == 0) {
            return;
        }
