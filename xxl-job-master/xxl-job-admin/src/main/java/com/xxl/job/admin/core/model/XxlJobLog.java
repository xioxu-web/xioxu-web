...
class XxlJobLog {
    ...
    public
    void setExecutorAddress(String executorAddress) {
    ...
    public
    String getExecutorShardingParam() {
        return executorShardingParam;
    }

    public
    void setExecutorShardingParam(String executorShardingParam) {
    ...
    public
    void setTriggerCode(int triggerCode) {
        this.triggerCode = triggerCode;
    }

    public
    String getTriggerMsg() {
        return triggerMsg;
    }

    public
    void setTriggerMsg(String triggerMsg) {
    ...
    public
    void setHandleCode(int handleCode) {
    ...
    public
    void setHandleMsg(String handleMsg) {
