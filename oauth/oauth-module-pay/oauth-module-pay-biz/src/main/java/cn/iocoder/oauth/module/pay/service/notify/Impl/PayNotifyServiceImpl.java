package cn.iocoder.oauth.module.pay.service.notify.Impl;
...
import cn.iocoder.oauth.module.pay.dal.dataobject.notify.PayNotifyTaskDO;
...
import cn.iocoder.oauth.module.pay.dal.mysql.notify.PayNotifyLogCoreMapper;
import cn.iocoder.oauth.module.pay.dal.mysql.notify.PayNotifyTaskCoreMapper;
import cn.iocoder.oauth.module.pay.dal.redis.notify.PayNotifyLockCoreRedisDAO;
import cn.iocoder.oauth.module.pay.enums.notify.PayNotifyStatusEnum;
import cn.iocoder.oauth.module.pay.enums.notify.PayNotifyTypeEnum;
import cn.iocoder.oauth.module.pay.service.notify.PayNotifyService;
import cn.iocoder.oauth.module.pay.service.notify.dto.PayNotifyTaskCreateReqDTO;
import cn.iocoder.oauth.module.pay.service.notify.vo.PayNotifyOrderReqVO;
import cn.iocoder.oauth.module.pay.service.notify.vo.PayRefundOrderReqVO;
...
public class PayNotifyServiceImpl implements PayNotifyService {
    ...
    public void createPayNotifyTask(PayNotifyTaskCreateReqDTO reqDTO) {
        ...
        if(Objects.equals(task.getType(), PayNotifyTypeEnum.ORDER.getType())){
            PayOrderDO order = orderService.getOrder( task.getId() );
            ...
            PayRefundDO refund = refundService.getRefund( task.getId() );
            task.setMerchantId( refund.getMerchantId()).setAppId(refund.getAppId())
                    .setMerchantOrderId( refund.getMerchantOrderId() ).setNotifyUrl(refund.getNotifyUrl());
        }
        //执行插入
    ...
    private CommonResult<?> executeNotifyInvoke(PayNotifyTaskDO task) {
        ...
        String response = HttpUtil.post(task.getNotifyUrl(), JsonUtils.toJsonString(request),
                Math.toIntExact( NOTIFY_TIMEOUT_MILLIS));
        // 解析结果
