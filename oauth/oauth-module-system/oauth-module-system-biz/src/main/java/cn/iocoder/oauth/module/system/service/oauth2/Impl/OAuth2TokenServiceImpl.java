...
import cn.iocoder.oauth.module.system.dal.mysql.oauth2.OAuth2AccessTokenMapper;
import cn.iocoder.oauth.module.system.dal.mysql.oauth2.OAuth2RefreshTokenMapper;
import cn.iocoder.oauth.module.system.dal.mysql.redis.oauth2.OAuth2AccessTokenRedisDAO;
...
public class OAuth2TokenServiceImpl implements OAuth2TokenService {
    ...
    private Logger logger= LoggerFactory.getLogger(OAuth2TokenServiceImpl.class);
    ...
    private OAuth2RefreshTokenDO createOAuth2RefreshToken(Long userId, Integer userType, OAuth2ClientDO clientDO, List<String> scopes) {
        ...
        logger.info("OAuth2TokenServiceImpl#createOAuth2RefreshToken got success：{}", JSONObject.toJSONString(refreshToken));
