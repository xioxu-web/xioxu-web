...
import cn.iocoder.oauth.framework.sms.core.client.SmsClient;
import cn.iocoder.oauth.framework.sms.core.client.SmsClientFactory;
import cn.iocoder.oauth.framework.sms.core.client.SmsCommonResult;
import cn.iocoder.oauth.framework.sms.core.client.dto.SmsReceiveRespDTO;
import cn.iocoder.oauth.framework.sms.core.client.dto.SmsSendRespDTO;
...
import cn.iocoder.oauth.module.system.service.sms.SmsLogService;
...
public class SmsSendServiceImpl implements SmsSendService {
    ...
    public Long sendSingleSms(String mobile, Long userId, Integer userType, String templateCode, Map<String, Object> templateParams) {
        ...
        String templateContent = smsTemplateService.formatSmsTemplateContent( template.getContent(), templateParams );
        Long sendLogId = smsLogService.createSmsLog( mobile, userId, userType, isSend, template, templateContent, templateParams );
        // 发送 MQ 消息，异步执行发送短信
        if(isSend){
