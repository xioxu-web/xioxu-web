package cn.iocoder.oauth.module.system.service.permission;
...
public interface PermissionService {
     ...
     * @return 菜单列表
     */
    List<MenuDO> getRoleMenuListFromCache(Collection<Long> roleIds, Collection<Integer> menuTypes, Collection<Integer> menusStatuses);
