package cn.iocoder.oauth.module.system.controller.admin.oauth2;
...
import cn.iocoder.oauth.framework.common.util.HttpUtils;
...
import cn.iocoder.oauth.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import cn.iocoder.oauth.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import cn.iocoder.oauth.module.system.convert.oauth2.OAuth2OpenConvert;
import cn.iocoder.oauth.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import cn.iocoder.oauth.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import cn.iocoder.oauth.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import cn.iocoder.oauth.module.system.enums.auth.OAuth2GrantTypeEnum;
import cn.iocoder.oauth.module.system.service.oauth2.Impl.OAuth2ApproveService;
import cn.iocoder.oauth.module.system.service.oauth2.OAuth2ClientService;
...
import cn.iocoder.oauth.module.system.util.oauth2.OAuth2Utils;
...
import static cn.iocoder.oauth.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.iocoder.oauth.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "username", example = "xiaoxu", dataTypeClass = String.class),
            @ApiImplicitParam(name = "password", example = "123456", dataTypeClass = String.class), // 多个使用空格分隔
