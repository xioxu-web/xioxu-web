...
import cn.iocoder.oauth.framework.sms.core.client.Impl.aliyun.AliyunSmsClient;
import cn.iocoder.oauth.framework.sms.core.client.Impl.debug.DebugDingTalkSmsClient;
    ...
    public SmsClientFactoryImpl() {
        ...
        Arrays.stream(SmsChannelEnum.values()).forEach(channel -> {
            ...
            SmsChannelProperties properties = new SmsChannelProperties().setCode(channel.getCode())
                    .setApiKey("LTAI5tCXLgk3rQQsMgR7FyKG").setApiSecret("6Cw9021rGsq8nzMmYnhihKD6So971O");
            // 创建 Sms 客户端
