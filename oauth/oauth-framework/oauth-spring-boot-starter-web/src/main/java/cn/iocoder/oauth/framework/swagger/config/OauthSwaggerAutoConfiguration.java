package cn.iocoder.oauth.framework.swagger.config;
...
@ConditionalOnProperty(prefix = "oauth.swagger", value = "enable", matchIfMissing = true)
// 允许使用 swagger.enable=false 禁用 Swagger
@EnableConfigurationProperties(SwaggerProperties.class)
public class OauthSwaggerAutoConfiguration {
