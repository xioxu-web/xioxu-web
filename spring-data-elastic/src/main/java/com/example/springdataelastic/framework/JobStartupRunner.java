package com.example.springdataelastic.framework;

import com.example.springdataelastic.config.quartz.QuartzConfiguration;
import com.example.springdataelastic.domain.QuartzJob;
import com.example.springdataelastic.domain.QuartzJob2;
import org.quartz.*;
...
public class JobStartupRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Scheduler scheduler;
        try {
            scheduler = quartzConfiguration.scheduler();
