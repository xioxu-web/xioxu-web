package com.example.springdataelastic.config.app;
...
public class AppConfig {
    ...
    @Value("${app.quartz.datasource.quartzDataSource.username}")
    private String quartzDatasourceQuartzDataSourceUserName;
    ...
    public
    String getQuartzDatasourceQuartzDataSourceUserName() {
        return quartzDatasourceQuartzDataSourceUserName;
    }

    public
    void setQuartzDatasourceQuartzDataSourceUserName(String quartzDatasourceQuartzDataSourceUserName) {
        this.quartzDatasourceQuartzDataSourceUserName = quartzDatasourceQuartzDataSourceUserName;
    }
