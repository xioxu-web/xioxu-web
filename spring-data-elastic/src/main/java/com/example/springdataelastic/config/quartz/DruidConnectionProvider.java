...
public class DruidConnectionProvider implements ConnectionProvider {
    ...
    public
    String getMaxCachedStatementsPerConnection() {
        return maxCachedStatementsPerConnection;
    }

    public
    void setMaxCachedStatementsPerConnection(String maxCachedStatementsPerConnection) {
        this.maxCachedStatementsPerConnection = maxCachedStatementsPerConnection;
    }

    public static
    int getDefaultDbMaxConnections() {
        return DEFAULT_DB_MAX_CONNECTIONS;
    }

    public static
    int getDefaultDbMaxCachedStatementsPerConnection() {
