 ...
 */
public class OauthFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    ...
    private Class<?> getSpringFactoriesLoaderFactoryClass(){
        return OauthFeignClientsRegistrar.class;
    }
