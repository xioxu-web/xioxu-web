package com.example.resourceserver_demo.controller;
...
public class CallbackController {
    ...
    public OAuth2AccessToken login(@RequestParam("code") String code) {
        ...
        restTemplate.getOAuth2ClientContext().getAccessTokenRequest().setPreservedState("http://127.0.0.1:8087/resource_server/callback"); // 通过这个方式，设置 redirect_uri 参数
